    ...
    <div className="space-y-4">
      ...
      {isLoading ? (
              ...
              <TableHeader>
                <TableRow className="bg-muted/50">
                  <TableHead className="cursor-pointer select-none" onClick={() => handleSort("name")}>
                    <span className="flex items-center">სახელი <SortIcon col="name" /></span>
                  </TableHead>
                  <TableHead className="cursor-pointer select-none" onClick={() => handleSort("email")}>
                    <span className="flex items-center">ელფოსტა <SortIcon col="email" /></span>
                  </TableHead>
                  <TableHead className="cursor-pointer select-none" onClick={() => handleSort("status")}>
                    <span className="flex items-center">სტატუსი <SortIcon col="status" /></span>
                  </TableHead>
                  <TableHead className="cursor-pointer select-none" onClick={() => handleSort("date")}>
                    <span className="flex items-center">თარიღი <SortIcon col="date" /></span>
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
        ...
        <div className="text-center py-10 text-muted-foreground text-sm">
          {search ? "შესაბამისი სტუმრები ვერ მოიძებნა." : "ჯერ რეგისტრაციები არ არის."}
        </div>
      )}
    </div>
  );
